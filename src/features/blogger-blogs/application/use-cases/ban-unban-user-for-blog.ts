...
export class BanUnbanUserForBlogUseCase
  implements ICommandHandler<BanUnbanUserForBlogCommand>
{
  constructor(
  ...
  async execute(command: BanUnbanUserForBlogCommand): Promise<boolean> {
