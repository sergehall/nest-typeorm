...
import { ChangeBanStatusUserBlogsCommand } from '../../../../blogger-blogs/application/use-cases/old/change-ban-status-owner-blog.use-case';
  ...
  implements ICommandHandler<SaBanUserByUserIdCommand>
{
  ...
  async execute(command: SaBanUserByUserIdCommand): Promise<boolean> {
    ...
    return await this.executeChangeBanStatusCommands(userToBan.id, banInfo);
  }
